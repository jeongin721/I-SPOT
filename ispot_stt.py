    ...
    def transcribe(self, audio_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.client.listen.v1.media.transcribe_file(
                ...
                # Deepgram SDK 요청 설정
                # 긴 음성/느린 네트워크에서도 충분히 기다리고,
                # 일시적인 요청 실패 시 최대 2회 재시도한다.
                request_options={
...
def _normalize_audio_path(audio_path: Union[str, os.PathLike]) -> Path:
...
class Transcriber:
    ...
    def transcribe(self, audio_path: Union[str, os.PathLike]) -> Dict[str, Any]:
        # 공부용 설명:
    ...
    def transcribe_and_diarize(self, audio_path: Union[str, os.PathLike]) -> Dict[str, Any]:
