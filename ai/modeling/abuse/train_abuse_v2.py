"""
A-only Hard Augmentation v2 데이터로 KLUE-RoBERTa 4-label 멀티라벨 모델을 학습한다.

기존 A-only baseline과 동일한 학습 조건을 유지하고, 보강 데이터의 효과를
...
BEST_MODEL_PATH = (
    WEIGHT_DIR
    / f"roberta_multilabel_v2_{DATE_STRING}.pth"
)
...
print("=" * 70)
print("A-only Multi-label v2 Training")
print("=" * 70)
...
# Baseline과 동일한 BCEWithLogitsLoss 사용.
# 이번 실험에서는 pos_weight를 추가하지 않는다.
