"""
I-SPOT 2차 15개 세부유형 RoBERTa v2를 학습한다.
Train 분포 기반 pos_weight를 적용해 희소 subtype의 Recall/F1 개선 여부를 실험한다.
"""
...
BEST_WEIGHT_PATH = WEIGHT_DIR / "roberta_subtype_v2_best.pth"
RESULT_PATH = RESULT_DIR / "roberta_subtype_v2_history.csv"
POS_WEIGHT_PATH = RESULT_DIR / "roberta_subtype_v2_pos_weight.csv"
...
def main():
    ...
    print()
    print("=" * 70)
    print("I-SPOT SUBTYPE MODEL V2 - POS WEIGHT")
    print("=" * 70)
